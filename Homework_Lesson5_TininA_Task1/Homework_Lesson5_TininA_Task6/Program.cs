...
namespace Homework_Lesson5_TininA_Task6
{
    ...
    class Program
    {
        ...
        {
            //разные всякие манипуляции с очередью и с типами для очереди. Проверка переполнения очереди, получение при пустой очереди и т.д.
    ...
    //пускай очередь будет максимум 100 элементов. Сделал обобщенным - захотел попрактиковаться в этом.
    class MyQueue<T>
    {
        T[] queueArray;
        int tale;
